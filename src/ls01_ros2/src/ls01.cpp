...
namespace LS01 {
    LS01::LS01(const std::string &node_name, const rclcpp::NodeOptions &options, speed_t baud_option) :
        ...
        std::string default_lidar_frame = "laser_link";
        std::string default_port = "/dev/ttyUSB0";
        auto default_range_min = 0.1;
        auto default_range_max = 8.0;
        ...
        this->get_parameter_or("scan_topic", scan_topic, default_scan_topic);
        this->get_parameter_or("lidar_frame", lidar_frame, default_lidar_frame);
        this->get_parameter_or("serial_port", port, default_port);
        this->get_parameter_or<float>("range_min", range_min, default_range_min);
        this->get_parameter_or<float>("range_max", range_max, default_range_max);
